...
$sql = "SELECT ID, naslov, datumdodajanja, vsebina FROM reference ORDER BY datumdodajanja DESC LIMIT 5";
$stmt = $db->prepare($sql);
$result = $stmt->execute();
...
<head>
  ...
  <link rel="stylesheet" href="css/index_design.min.css?v=1.2">
...
<body class="pushable">
  ...
  <div class="ui vertical sidebar menu">
    ...
    <a href="#opodjetju-anchor" id="mobile-about-cpmn" class="active item">O podjetju</a>
    <a href="vse.php?type=novice" class="item">Novice</a>
    <a href="vse.php?type=reference" class="item">Reference</a>
    <a href="#kontakt-anchor" id="mobile-cntc" class="item">Kontakt</a>
  ...
  <div class="pusher">
        ...
        <div class="column">
          <div id="navbar" class="ui massive fixed borderless secondary menu">
            ...
            <div class="right menu">
              <div class="item">
                <a id="about-company-nav" href="#opodjetju-anchor">O podjetju</a>
              </div>
              <div class="item">
              ...
              <div class="item">
                <a href="#kontakt-anchor">Kontakt</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="ui container carousel-container">
        <h1 id="carousel-header" class="display-4">Prepustite delo strokovnjakom</h1>
        <p id="carousel-paragraph" class="lead">Pridružite se našim zadovoljnim strankam</p>
      </div>
                              ...
                              <div class="item">
                                ...
                                <div class="content">
                                  ...
                                  <div class="description">
                                    <p style="font-size: 15px; line-height: 0; font-style: italic">Datum izvedbe: ' . $value['datumdodajanja'] . '</p>
                                    <br>
                                    <p>' . $value['podnaslov'] . '</p>
                                    <a href="novica.php?id='.$value['ID'].'">Pokaži več</a>
                                  </div>
                                </div>
                              </div>
                            ';
    ...
    <div class="ui container">
      ...
      <div class="ui stackable two column grid" style="height: 100%">
        <div class="column" style="display: flex; justify-content: center; align-items: center; flex-direction: column">
          <img src="res/logo-2_optimized-248x100.png?v=1.1" style="width: auto; height: 100px">
          <br>
  ...
  <script src="js/index_script.min.js?v=1.0" charset="utf-8"></script>
  <script src="js/global.min.js" charset="utf-8"></script>
  <script src="js/stin-carousel.min.js?v=1.1" charset="utf-8"></script>
</body>
